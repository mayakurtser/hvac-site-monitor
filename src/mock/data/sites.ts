  ...
  return [
    ...
    addTrend({
      ...
      alertList: [
        {
          id: 'a1',
          desc: 'Indoor unit IDU-18 temperature above setpoint',
          severity: 'warning',
          at: minutesAgo(12),
        },
        {
          id: 'a2',
          desc: 'Filter maintenance overdue — Zone 3',
          severity: 'info',
          at: hoursAgo(1),
        },
        {
          id: 'a3',
          desc: 'Outdoor unit ODU-4 elevated discharge pressure',
          severity: 'warning',
          at: hoursAgo(3),
        },
      ],
    ...
    addTrend({
      id: 'north-data-center',
      name: 'North Data Center',
      ...
      alertList: [
        {
          id: 'b1',
          desc: 'CRAC unit CR-2 compressor fault',
          severity: 'critical',
          at: minutesAgo(4),
        },
        {
          id: 'b2',
          desc: 'Hot aisle temperature exceeded 30°C',
          severity: 'critical',
          at: minutesAgo(9),
        },
        {
          id: 'b3',
          desc: 'Redundant unit CR-5 failed to start',
          severity: 'critical',
          at: minutesAgo(22),
        },
        {
          id: 'b4',
          desc: 'Controller CTL-3 lost connection',
          severity: 'warning',
          at: minutesAgo(40),
        },
        {
          id: 'b5',
          desc: 'Chilled water flow below threshold',
          severity: 'warning',
          at: hoursAgo(1),
        },
      ],
    ...
    addTrend({
      id: 'westfield-logistics',
      name: 'Westfield Logistics Hub',
      customer: 'Cargill Distribution',
      ...
      alertList: [
        {
          id: 'c1',
          desc: 'Zone 7 humidity above range (68%)',
          severity: 'warning',
          at: minutesAgo(26),
        },
        {
          id: 'c2',
          desc: 'Scheduled maintenance window starts in 2 hrs',
          severity: 'info',
          at: hoursAgo(1),
        },
      ],
    ...
    addTrend({
      ...
      alertList: [
        {
          id: 'd1',
          desc: 'Unit IDU-9 in scheduled maintenance',
          severity: 'info',
          at: hoursAgo(2),
        },
      ],
    ...
    addTrend({
      ...
      alertList: [
        {
          id: 'e1',
          desc: 'Site gateway offline — no telemetry received',
          severity: 'critical',
          at: minutesAgo(18),
        },
      ],
    ...
    addTrend({
      ...
      alertList: [
        {
          id: 'f1',
          desc: 'Freezer room B above target temperature',
          severity: 'warning',
          at: minutesAgo(14),
        },
    ...
    addTrend({
      id: 'gateway-airport',
      name: 'Gateway Airport Terminal C',
      customer: 'Metro Aviation Authority',
      city: 'Kansas City, MO',
      status: 'online',
      units: 188,
      indoor: 150,
